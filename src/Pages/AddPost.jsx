    ...
    <div className="max-w-xl mx-auto mt-10 p-6 shadow-xl rounded-xl bg-base-200 border border-gray-300/40 dark:border-gray-600/40">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1">
          ...
          <input type="text" name="title" placeholder="Enter a compelling title" className="input input-bordered w-full" required />
        </div>
        ...
        <div className="space-y-1">
          ...
          <input type="text" name="location" placeholder="Where will volunteering take place?" className="input input-bordered w-full" required />
        </div>
        ...
        <div className="space-y-1">
          ...
          <input type="url" name="image" placeholder="Enter a thumbnail URL" className="input input-bordered w-full" required />
        </div>
        ...
        <div className="space-y-1">
          ...
          <textarea name="description" placeholder="Describe what volunteers will do..." className="textarea textarea-bordered w-full" maxLength={500} required />
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <input type="number" name="volunteersNeeded" placeholder="Number of volunteers" className="input input-bordered w-full" min="1" required />
          </div>
